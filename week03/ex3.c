...
int main()
{
    ...
    Directory home = {0, 0, {}, {}, "/home"}, bin = {0, 0, {}, {}, "/bin"}, root = {0, 0, {}, {}, "/"};
    ...
    File bash = {0, "bash", 0, "", NULL}, ex31 = {1, "ex3_1.c", 0, "", NULL}, ex32 = {2, "ex3_2.c", 0, "", NULL};
...
void add_to_file(File *file, const char *content)
{
    if (file)
    {
        ...
        file->size = sizeof(content) / sizeof(content[0]);
    }
}
